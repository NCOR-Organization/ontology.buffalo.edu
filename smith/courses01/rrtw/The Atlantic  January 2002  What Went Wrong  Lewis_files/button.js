...
var btn=new Image();
btn.src="http://imp.clickability.com/"+Math.random()+"&"+escape(getClickTitle())+"&"+escape(getClickURL())+"?1"+"1"+"1"+"0"+"0"+"0"+"0000|"+"5210"+"|"+"4300"+"|"+"3060"+"|"+"54"+"|"+"54"+"|"+"1"+"|"+version+"|";
...
var saveLoc="http://theatlantic.foreign.savethis.clickability.com/st/saveThisApp?clickMap=saveThis"+commonLoc;
var emailLoc="http://theatlantic.foreign.emailthis.clickability.com/et/emailThis?clickMap=create"+commonLoc;
var printLoc="http://theatlantic.foreign.printthis.clickability.com/pt/printThis?clickMap=printThis"+commonLoc;
var popularLoc="http://theatlantic.foreign.emailthis.clickability.com/et/emailThis?clickMap=topTen&fb=Y&MPbut=Y&popularType=1&partnerID="+partnerID+"',"+popWin;
