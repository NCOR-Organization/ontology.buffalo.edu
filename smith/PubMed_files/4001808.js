...
(function ($){
        ...
        socialButtons.socialShare = function (shareName, shareURL,node) {
            ...
            var postUrl = socialButtons.buildUrl(shareName, shareURL,node);
        ...
        socialButtons.buildUrl = function (shareName, shareURL,node) {
            ...
            jQuery.each(options.shareParameters, function (paramKey, paramValue) {
                ...
                if (paramValue !== '') {
                    parameters.push(paramKey + '=' + encodeURIComponent(paramValue == 'shareURLPlaceholder' ? urlToShare: paramValue));
                }
            });
            ...
            (function(){
                ...
                return {
                    ...
                    'scanNcbiSocial':function(root){
                        ...
                        var readShareWidgetConfig = function (configStr){
                            var shareConfigJ = {}
                            if (configStr) {
                                try{
                        ...
                        var sharePNodes = allShareNodes.not('.jig-ncbipopper').filter(function(ind){
                            return readShareWidgetConfig($(this).data('ncbi_share_config')).popup !== false;
                        });
                        ...
                        shareInPNodes.each(function(index,elem){
                           var self = $(this);
                           self.replaceWith($.ncbi.share.shareUL);
                        });
                    ...
                    $('.comm_nlines').each(function(i,n){
                        ...
                        if (commItem.is(':visible')){
                            ...
                            while (search){
                                ...
                                if (currItem.find('.comm_f_name').attr('href') == authorLink){
                                    search = true;
